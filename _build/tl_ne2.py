...
# -----------------------------------------------------------------------------
ref('nx_asurarali', 'Treaty of Asurar Ali, February 1639', 'Wikipedia: Allah Yar Khan for the Mughals and Momai Tamuli for the Ahoms fix the frontier at the Barnadi on the north bank and the Asurar Ali causeway at Guwahati on the south.', 'https://en.wikipedia.org/wiki/Treaty_of_Asurar_Ali')
ref('nx_itakhuli', 'Battle of Itakhuli, 1682', 'Wikipedia: the Ahoms drive the Mughals about 100 km west, after which the Manas is the Ahom–Mughal boundary until the British arrive.', 'https://en.wikipedia.org/wiki/Battle_of_Itakhuli')
ref('nx_goalpara', 'Undivided Goalpara district', 'Wikipedia: Mughal sarkar Dhekuri, lying between the Sankosh and the Manas, passed to the Company with Bengal and was administered from Rangpur until Regulation X of 1822 severed it as “North-East Rangpur”.', 'https://en.wikipedia.org/wiki/Undivided_Goalpara_district')
...
timeline('Assam|Bangladesh',
    ('1639–1682', 'Mughal Bengal’s frontier against the Ahom kingdom is fixed by the Treaty of Asurar Ali in February 1639 at the Barnadi on the Brahmaputra’s north bank and the Asurar Ali causeway at Guwahati on the south, then pushed back to the Manas after the Ahom victory at Itakhuli in 1682. Both lines lie deep inside modern Assam, so no part of this border descends from them.', ['nx_asurarali', 'nx_itakhuli']),
    ('1822', 'West of the Manas, Mughal sarkar Dhekuri — the later Goalpara — lay inside Bengal Subah alongside Rangpur, so there is no old provincial line in this sector at all: it is cut by Regulation X of 1822, which severs Goalpara, Dhubri and Koraibari from Rangpur as “North-East Rangpur”, constituted a district in 1833 and attached to Assam.', ['nx_goalpara']),
